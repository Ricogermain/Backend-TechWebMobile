-- Combined Prisma migrations (chronological)
-- Paste this entire file into Neon SQL editor and execute

-- Migration: 20260725175156_init
-- --------------------------------------------------
-- CreateEnum
...
-- Migration: 20260730062313_ajout_stock_sur_vehicule
-- --------------------------------------------------
ALTER TABLE "vehicules" ADD COLUMN "stock" INTEGER NOT NULL DEFAULT 1;


-- Migration: 20260731204703_ajout_annulee_sur_statut_livraison
-- --------------------------------------------------
